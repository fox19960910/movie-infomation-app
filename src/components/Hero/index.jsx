...
const Hero = () => {
    ...
    return (
        <div className="hero">
            ...
            >
               {
                   movieItems && movieItems.length > 0 && movieItems.map((item,index) => (
...
const HeroItems = ({item,className}) => {
    ...
    const background = item && apiConfig.originalImage( item.backdrop_path) ? apiConfig.originalImage( item.backdrop_path) : apiConfig.originalImage( item.backdrop_path)
    return(
            <div 
                ...
                >
                    <div className="hero__content container">
                        <div className="hero__info">
                            ...
                            <div className="btns">
                                <Btn onClick={() => history.push('/movie' + item.id)}>Watch now</Btn>
                            </div>
                        </div>
